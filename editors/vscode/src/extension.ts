...
export async function activate(context: vscode.ExtensionContext) {
    ...
    vscode.commands.registerCommand("uvls.generate_configurations", async () => {
        if (!client) {
            return;
        }
        ...
        quickPick.onDidAccept((e) => {
            ...
            if (client) {
                ...
                client.sendRequest(ExecuteCommandRequest.method, {
                    command: "uvls/generate_configurations",
                    arguments: [uri.toString(), value],
                }).then((v) => console.log('executed', v));
